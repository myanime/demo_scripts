...
#proxyStartNumber = [23, 60, 120, 180, 240, 300, 360, 420, 480, 540, 600, 660, 720, 780, 840, 900, 960, 1020, 1080, 1140, 1200, 1260, 1320, 1380, 1440, 1500]
#To these valuse were done by dastelephon buch
currentRowInSearchListArray = [490, 126, 685, 493, 567, 550, 342, 519, 675, 865, 940, 331, 317, 879, 715, 1137, 1174, 943, 1307, 909, 636, 535, 997, 545, 482]
currentRowInSearchListArray = [534, 1396, 685, 506, 586, 550, 342, 540, 675, 865, 940, 336, 317, 883, 715, 1176, 1174, 943, 1311, 909, 655, 535, 997, 545, 482]
#currentRowInSearchListArray = [0, 5000, 5000, 5000, 5000, 6000, 6000, 6000, 6000, 6000, 6000, 331, 317, 879, 715, 1137, 1174, 943, 1307, 909, 636, 535, 997, 545, 482]
...
class Farmer:
    def __init__(self, myFileNameSave, myFileNameLoad, threadNumber, wantedProxyNumber, currentRowInSearchList):
        ...
        self.numberOfProxiesInList = 1500

        ##########Loads Proxy List into Array################
        proxyArray = [None] * 1500
        proxyNumber = 0
