...
myStartPage = 0
myEndPage = 11
#If you restar and 100 pages have already been downloaded change the interval to 100
myInterval = 20
apple = False
...
################################## HEADER ##################################
directoryArray = [\
"/Users/shuzhang/researchScraper/NoState/new21000",\
"/Users/shuzhang/researchScraper/NoState/new21000",\
"/Users/shuzhang/researchScraper/NoState/new21000",\
"/Users/shuzhang/researchScraper/NoState/new21000",\
"/Users/shuzhang/researchScraper/NoState/new21000",\
...
myCurrentPage = [\
#0 need from 23191 to 23332 (141 items)
23191,\
#1done 11417 need 20 items 409
23210,\
#2done
23230,\
#3**9000*10*11***
...
def multiThreading():
    for number in range (myStartPage, myEndPage):
        try:
            threadEndPage = myCurrentPage[number] + myInterval
