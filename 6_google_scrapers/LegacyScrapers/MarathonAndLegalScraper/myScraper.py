...
def cellSelector2(rowNumber, colNumber):
...
cells = html.xpath(".//table[1]/tbody/tr[2]/td[1]/text()")
cells2 = html.xpath("//table[1]/tbody/tr[2]/td[2]/text()")
cells3 = html.xpath(".//table[1]/tbody/tr[2]/td[3]/text()")
print cells
print cells2
print cells3

xText = str(cells).encode('utf-8')
f = open('myCSVFile', 'a')
f.write(xText)
f.close()
"""
