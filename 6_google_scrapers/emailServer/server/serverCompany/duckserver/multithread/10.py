...
thread1start = 5000 * serverNumber
thread2start = (5000 * serverNumber) + 2500
myInterval = 2500

name1Start = 5000 * serverNumber
name2start = (5000 * serverNumber) + 2500
nameInterval = 2500
...
nameArray = [name1Start, name2start]
...
def multiThreading():
    for number in range (0, 2):
        ...
        try:
            ...
            nameStart = nameArray[number]
            modifier = "_" + str(nameStart) + "-" + str(nameInterval)
            myFileNameSave = myThreadNumber + searchEngine + modifier + ".csv"
