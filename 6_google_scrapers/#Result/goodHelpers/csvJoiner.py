...
SAVE_TO_DIRECTORY = "/home/myanime/Desktop/webScrapers/#Result/SecondHalf/Downloads/Emails/merged/RawData/"
completeFile = "/home/myanime/Desktop/webScrapers/#Result/SecondHalf/Downloads/Emails/merged/RawData/completeFile.csv"
listLoad = [None] * 2000
...
for x in range (0, 2000):
    ...
    with open(myFileNameLoad, 'rb') as pageList:
        ...
        for row in itertools.islice(stateReader, start, end):
            ...
            with open(completeFile, 'a') as saveFile:
